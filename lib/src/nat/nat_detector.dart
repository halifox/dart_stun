...
class NatDetector {
  ...
  factory NatDetector.fromUri(
    ...
    Duration initialBindingLifetimeProbe = const Duration(seconds: 15),
    Duration maxBindingLifetimeProbe = const Duration(minutes: 2),
    Duration bindingLifetimePrecision = const Duration(seconds: 1),
    int fragmentPaddingBytes = 1400,
